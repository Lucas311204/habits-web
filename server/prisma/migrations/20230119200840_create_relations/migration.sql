/*
  ...
  - Added the required column `dayId` to the `DayHabits` table without a default value. This is not possible if the table is not empty.
  - Added the required column `habitId` to the `DayHabits` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_DayHabits" (
    ...
    CONSTRAINT "DayHabits_day_id_fkey" FOREIGN KEY ("day_id") REFERENCES "Day" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
